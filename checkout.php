...
<body>
  <div id="div0">
  <h1 style="margin-left:20px"><font face="Agency FB">Pay</font></h1><hr>
</div>
 <!-- <div id="left">
<ul>
  <li><a href="checkout.php">Credit Card</a></li>
  <li style="background-color:#b9191c"><a href="checkout.php"><font color="white">Debit Card</font></a></li>
  <li><a href="checkout.php">Net Banking</a></li>
  <li><a href="checkout.php">Wallets</a></li>
  <li><a href="checkout.php">Paypal</a></li>
  <li><a href="checkout.php">UPI</a></li>
  <li><a href="checkout.php">Installments</a></li>
  <li><a href="checkout.php">Cash on Delivery</a></li>
</ul>
</div>  -->
<div id="left1">
<form method="post">
  ...
  <!--  <tr>
    ...
    <tr>
      <td><font size="6" color="#009900"><b>Card Details</b></font><hr></td>
    </tr>
    <tr>
      <td>Card Type</td>
    ...
    <tr>
      ...
      <tr>
        <td><font size="6" color="#009900"><b>Address</b><hr></font></td>
      </tr>
      <tr>
        <td>Username</td>
      ...
      <tr>
        <td><img src="capcha.jpg" width="150px" height="40px" border="1" /></td>
...
?>
      <p align="right"><font face="Agency FB" size="5">IT Security</font></p><hr align="right" style="width:25%">
  <p align="right"><font color="red" face="Agency FB" size="8">Total Payment:  ₹<font color="blue"><?php echo $sum;?></font></font></p>
  <?php 
if (isset($_POST['okay']))
  {
  $Address=$_POST['addr1'];
  ...
  $exec =mysqli_query($con,$query_string) or die(mysqli_error($con));
  if($exec==1)
